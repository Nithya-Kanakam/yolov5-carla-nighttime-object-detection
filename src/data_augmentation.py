...
# ==== CONFIG ====
SOURCE_IMG_DIR = 'c:/carla/augmented_final/images'
SOURCE_LABEL_DIR = 'c:/carla/augmented_final/labels'

OUTPUT_IMG_DIR = 'augmented_final_check/images'
OUTPUT_LABEL_DIR = 'augmented_final_check/labels'
...
for img_name in tqdm(image_files, desc="Augmenting images"):
    ...
    if os.path.exists(label_path):
        ...
        print(f"⚠️ Warning: No label found for {img_name}, skipping label.")
